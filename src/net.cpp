...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Mobilecash " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0xbb03c405, 0xae4023b9, 0x86ed0251, 0xdb326956, 0xe3fbba5d, 0xe9d32bb9
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Mobilecash is probably already running."), addrBind.ToString().c_str());
        else
