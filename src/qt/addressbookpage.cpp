    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your Mobilecash addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ...
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Mobilecash addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you."));
    ...
    case StealthAddressTab:
        ui->labelExplanation->setText(tr("These are your Mobilecash stealth addresses for receiving payments."));
        ui->deleteAddress->setVisible(false);
        ui->signMessage->setVisible(false);
